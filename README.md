...
![Equation](https://latex.codecogs.com/png.latex?W_{ij}=%20\frac{\left|\sum_{t=0}^{N-1}%20w_t\,\tilde{F}_i(t)\,\tilde{F}_j(t)\right|}
{\sqrt{\left(\sum_{t=0}^{N-1}%20w_t\,\tilde{F}_i(t)^2\right)\,\left(\sum_{t=0}^{N-1}%20w_t\,\tilde{F}_j(t)^2\right)}})
